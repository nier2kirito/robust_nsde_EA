...
def train_nsde_MSE(model, z_test, config):
...
def train_nsde_Wass(model, z_test, config):
...
if __name__ == '__main__':
    ...
    print("\n MSE:\n")
    model = train_nsde_MSE(model, z_test, CONFIG)
    print("\n Wass:\n")
    model = train_nsde_Wass(model, z_test, CONFIG)
